(function (global, factory) {
  ...
  (function () {
    (0, _jquery.default)('#newPaymentLInk').formValidation({
      framework: "bootstrap4",
      button: {
        selector: '#btnSave',
        disabled: 'disabled'
  ...
  })(); // Input Validataion Creating New Payment Link for lunapay v3
  // -------------------------------
  (function () {
    (0, _jquery.default)('#editPaymentlink1').formValidation({
      framework: "bootstrap4",
      button: {
        selector: '#btnSave',
        disabled: 'disabled'
